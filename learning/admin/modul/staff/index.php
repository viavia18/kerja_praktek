				...
				<div class="navbar-menu-wrapper d-flex align-items-center" style="background-color: #1991eb;">
					<ul class="navbar-nav navbar-nav-right" style="border-top-left-radius:50px;color: black;border-bottom-left-radius:50px;color: #fff;border:1px">
						<li class="nav-item d-none d-lg-block">
							...
							<b>My Profile</b>
							<img class="img-xs rounded-circle" src="../vendor/images/img_Users/<?=$data['image']; ?>" alt="">
							</a>
						</li>
					</ul>
			...
			<div class="container-fluid page-body-wrapper">
						...
						<li class="nav-item nav-profile">
							<div class="nav-link">
								<div class="profile-image"> 
									<img src="../vendor/images/img_Users/<?=$data['image']; ?>" alt="image" style="border:3px solid black;"/> 
				...
				<div class="main-panel">
					...
					if ($act=='') {
						...
						include 'modul/case/active_essay.php';
					}elseif ($act=='closeessay') {
						include 'modul/case/close_essay.php';
					}elseif ($act=='editessay') {
						include 'modul/case/edit_essay.php';
					}elseif ($act=='delessay') {
						include 'modul/case/del_essay.php';
					}elseif ($act=='status') {
						include 'modul/case/view_statusujian.php';
					}elseif ($act=='delkelas') {
						include 'modul/case/del_kelasujian.php';
					}elseif ($act=='addkelasujian') {
						include 'modul/case/add_kelasujian.php';
					}elseif ($act=='addkelasujiane') {
						include 'modul/case/essay/add_kelasujian.php';
					}elseif ($act=='delkelase') {
						include 'modul/case/essay/del_kelasujian.php';
					}
					}elseif ($page=='setting') {
						if ($act=='') {
