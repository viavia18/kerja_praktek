					...
					<div class="table-responsive">
						<table class="table table-striped table-hover table-condensed" id="data">
							...
							<tbody>
								<?php 
								$no=1;
								$sqlrole = mysqli_query($con,"SELECT * FROM cases");
								...
								<tr>
									...
									<a href="?page=case&act=soal&id=<?=$row['id']; ?>" class="btn btn-primary btn-sm text-white">Pertanyaan  ( <b><?=$jmlSoal; ?></b> )</a>
									</td>
									<td> 
									<a href="?page=case&act=ulasanadd&id=<?=$row['id']; ?>" class="btn btn-sm text-white" style="background-color: #FF5722;">Lihat Ulasan</a>
									</td>
