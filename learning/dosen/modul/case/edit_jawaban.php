...
if($d['video']!=""){
	$cek1='checked';
	$teks1='-- Jawaban ini memiliki Video tersimpan';
	$show2='style="display: none;"';
}
else if($d['image']!=""){
	$cek2='checked';
	$teks2='-- Jawaban ini memiliki Gambar tersimpan';
...
if($d['video_en']!=""){
	$cek1_en='checked';
	$teks1_en='-- Jawaban ini memiliki Video tersimpan';
	$show2_en='style="display: none;"';
}
else if($d['image_en']!=""){
	$cek2_en='checked';
	$teks2_en='-- Jawaban ini memiliki Gambar tersimpan';
...
<div class="content-wrapper">
	...
	<h4>
	Pertanyaan <small class="text-muted">/ Edit Jawaban</small>
	</h4>
	<hr>
	<div class="row">
					...
					<div class="card">
						<div class="card-body">
							...
							<form class="forms-sample" action="index.php?page=case&act=proses" method="post" enctype="multipart/form-data">
								...
								<input type="hidden" name="image_old" value="<?='../../assets/img/img_Answers/'.$target.$d['image']; ?>">
								<input type="hidden" name="image_en_old" value="<?='../../assets/img/img_Answers/'.$target.$d['image_en']; ?>">
								...
								<hr>
								<button type="submit" name="update_jawaban" class="btn btn-info mr-2">Simpan</button>
