	...
	<div class="row purchace-popup">
        <div class="col-md-12">
            <span class="d-flex alifn-items-center">
				<a href="?page=case&act=soaladd&id=<?=$_GET[id]; ?>" class="btn btn-dark"> <i class="fa fa-plus text-white"></i> Add Pertanyaan</a>
            </span>
        </div>
    </div>
	<div class="row">
		<div class="col-md-12 col-xs-12">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title">Pertanyaan Soal</h4>
						...
						<table class='table table-striped'>
							...
							<?php 
								...
								?>
									...
									<td>
										<a href="?page=case&act=jawabanadd&id_question=<?=$r['id']; ?>&id_case=<?=$_GET[id] ?>" class="btn btn-primary btn-sm text-white">+</a> 
